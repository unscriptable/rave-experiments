...
;define('amd-bundle/write', ['require'], function (require) {
...
if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
	...
	define('fastclick/lib/fastclick', function () {
		'use strict';
		return FastClick;
	});
...
;define('amd-bundle/formatPackages', function () {
...
;define('bootstrap/dist/js/bootstrap', ['jquery/jquery'], function ($cram_0) {
/*!
...
;define('aerogear-pipeline/aerogear.pipeline', ['jquery/jquery'], function ($cram_0) {
...
;define('amd-bundle/displayMetadata', ['require', 'exports', 'module', './formatPackages'], function (require, exports, module, $cram_r0) {

var formatPackages = $cram_r0;
...
;define('amd-bundle/main', ['amd-bundle/displayMetadata', 'amd-bundle/write', 'bootstrap/dist/js/bootstrap', 'aerogear-pipeline/aerogear.pipeline', 'lodash/dist/lodash', 'fastclick/lib/fastclick'], function (displayMetadata, write, bootstrap, agPipeline, _, $cram_5) {
